        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tighter mb-8 leading-tight">
              Propulser Votre <br />
              <span className="text-foreground/40">Succès Technique</span>
            </h2>
            
            <p className="text-muted-foreground mb-10 text-lg font-light leading-relaxed max-w-lg">
            ...
            <div className="space-y-4 mb-10">
              {projects.map((project, index) => (
                <motion.div
                  ...
                  className="flex gap-5 p-5 rounded-2xl bg-secondary/50 border border-border hover:border-brand-gold/20 transition-all duration-300 group"
                >
                  <div className="w-12 h-12 rounded-xl bg-accent flex items-center justify-center flex-shrink-0 group-hover:bg-brand-red/10 transition-colors">
                    <project.icon className="w-5 h-5 text-muted-foreground group-hover:text-brand-red" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      <h4 className="font-bold text-foreground tracking-tight">{project.title}</h4>
                    ...
                    <p className="text-sm text-muted-foreground font-light">{project.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
