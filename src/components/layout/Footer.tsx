    ...
    <footer className="bg-card border-t border-border">
      <div className="container-wide py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-foreground tracking-tight mb-6">Navigation</h4>
            <ul className="space-y-3">
                ...
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-sm text-muted-foreground hover:text-brand-gold transition-colors duration-200 font-light"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            {/* Contact Info */}
            <div>
              <h4 className="font-bold text-foreground tracking-tight mb-6">Contact</h4>
        ...
        <div className="mt-20 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs text-muted-foreground/30 font-medium uppercase tracking-widest">
            © {new Date().getFullYear()} Soma Lubrifiants. Tous droits réservés.
          </p>
          <div className="flex items-center gap-8">
            <Link
              to="/legal"
              className="text-xs text-muted-foreground/30 hover:text-foreground transition-colors uppercase tracking-widest font-medium"
            >
              Mentions Légales
            </Link>
            <Link
